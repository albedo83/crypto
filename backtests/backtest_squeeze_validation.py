...
from backtests.backtest_squeeze import detect_squeeze_signals, backtest_squeeze, score
...
def main():
    ...
    from backtests.backtest_genetic import build_features as bf
    from backtests.backtest_sector import compute_sector_features, SECTORS, TOKEN_SECTOR
