...
| 13 | MFE/MAE | ticks 20s (mark) — **v1.8.0 : les règles TRAIL lisent un MFE échantillonné aux clôtures 4h et ne s'évaluent qu'à ces clôtures = convergence avec le BT** (chantier trails-sur-close, A′ 7/7 + contrefactuel réel n=98 Δ+98 bps). Les coupe-pertes gardent le MFE tick | close de bougie 4h (mfe_on_close, v1.4.0) | divergence FERMÉE pour les trails ; résiduelle pour les dead-detectors (conservateurs au tick) |
