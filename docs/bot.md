...
| **S8 dead-in-water exit** (v12.6.0) | À T+8h, si S8 LONG a `mfe_bps ≤ 50` (jamais respiré +0.5%) → cut immédiat. | Nettoie les S8 amorphes sans pouls. Pair opposé du trail (MFE ≤ 50 vs ≥ 300/1500). Validé walk-forward 28m/12m/6m positifs + 3m null + DD jamais dégradée. |
