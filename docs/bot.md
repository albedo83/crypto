...
| **Adaptive modulator** (v11.10.0) | S1×(1+0.5·btc_z), S8×(1−0.5·btc_z), S9×(1−0.5·btc_z) — non actif sur S5/S10 | btc_z = z-score rolling 6m du return BTC 30j. Reflète la régime-dependance de chaque signal : S1 bull, S8/S9 bear/choppy. Validé : walk-forward 4/4 + IS/OOS split + sliding walk-forward + null-shuffle 13× signal/noise + lookback robuste 30-90j + rolling z sans look-ahead. S5/S10 exclus car instables OOS. Multiplier clip [0.3, 2.5]. |
